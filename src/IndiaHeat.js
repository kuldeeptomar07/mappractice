...
import am5geodata_india2020Low from "@amcharts/amcharts4-geodata/india2020Low";
...
// Create chart
var chart = root.container.children.push(am5map.MapChart);
chart.panX = "rotateX";
chart.panY = "none";
chart.projection = new am5map.geoEqualEarth()
chart.layout = root.horizontalLayout;
